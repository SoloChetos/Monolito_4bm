<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OlvidasteContrasena.aspx.cs" Inherits="Monolito_4bm.OlvidasteContrasena" %>
<!DOCTYPE html>
<html lang="es">
<head runat="server">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .recover-wrapper { width: 100%; max-width: 450px; }
        .recover-card {
    ...
    <form id="form1" runat="server">
        ...
        <div class="recover-wrapper">
            <div class="recover-card">
                ...
                <p class="text-muted mb-4">Ingresa tu nick o correo electrónico. Te enviaremos una clave temporal por WhatsApp.</p>

                <div class="mb-3 text-start">
                    <label class="form-label">Nick o correo</label>
                    <asp:TextBox ID="txtIdentificador" runat="server" CssClass="form-control" placeholder="Ingresa tu nick o correo" required="required" />
                </div>

                <asp:Button ID="btnEnviarClave" runat="server" Text="Enviar clave por WhatsApp" CssClass="btn btn-primary w-100" OnClick="btnEnviarClave_Click" />
