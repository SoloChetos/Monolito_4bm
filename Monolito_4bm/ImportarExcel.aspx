<%@ Page Title="Importar Productos" Language="C#" MasterPageFile="~/PrincipalMaster.master" AutoEventWireup="true" CodeBehind="ImportarExcel.aspx.cs" Inherits="Monolito_4bm.ImportarExcel" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-dark m-0"><i class="fas fa-file-import me-2" style="color:#555;"></i>Importación Masiva</h2>
        <a href="Productos.aspx" class="btn btn-outline-secondary btn-sm"><i class="fas fa-arrow-left me-1"></i> Volver a Productos</a>
    </div>
    ...
    <div class="row mb-4 p-3 bg-light rounded border">
        <div class="col-md-4">
            <div class="form-check">
                ...
                <label class="form-check-label text-dark fw-medium" for="chkSoloNuevos">Solo nuevos productos</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check">
                <asp:CheckBox ID="chkActualizarExistentes" runat="server" CssClass="form-check-input" Checked="true" ClientIDMode="Static" />
                <label class="form-check-label text-dark fw-medium" for="chkActualizarExistentes">Actualizar productos existentes (por ID)</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-check">
                <asp:CheckBox ID="chkEliminarNoIncluidos" runat="server" CssClass="form-check-input" ClientIDMode="Static" />
                <label class="form-check-label text-dark fw-medium" for="chkEliminarNoIncluidos">Eliminar productos que no están en el archivo</label>
            </div>
        </div>
        <div class="col-12 mt-2">
            <small class="text-danger"><i class="fas fa-info-circle"></i> Si desmarca <strong>todas</strong> las casillas, se realizará un borrado total (físico) de productos y se reiniciarán los IDs.</small>
            <br />
    ...
    <asp:Panel ID="pnlPreview" runat="server" Visible="false">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                ...
                <p class="text-muted small">Revise que los números y precios estén correctos antes de confirmar.</p>
    ...
    <script>
        ...
        function confirmarImportacion(btn) {
            ...
            var soloNuevos = document.getElementById('chkSoloNuevos').checked;
            var mensaje = "Se procesarán los datos del archivo cargado.";
            var icono = "info";

            if (soloNuevos) {
                mensaje = "Se agregarán los productos como nuevos registros, sin afectar los existentes.";
            } else if (!actualizarMarcado && !eliminarMarcado) {
                mensaje = "¡ATENCIÓN! Ambas casillas están desmarcadas. Esto ELIMINARÁ TODOS LOS PRODUCTOS ACTUALES de la base de datos de forma irreversible antes de importar los nuevos.";
                icono = "warning";
            }
