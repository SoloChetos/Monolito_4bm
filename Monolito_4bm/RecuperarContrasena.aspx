<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecuperarContrasena.aspx.cs" Inherits="Monolito_4bm.RecuperarContrasena" %>
<!DOCTYPE html>
<html lang="es">
<head runat="server">
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="recover-container">
            ...
            <p class="subtitle">Ingrese su nick o correo. Se enviar&#225; una clave temporal a su WhatsApp.</p>

            <div class="form-floating">
                <asp:TextBox ID="txtNickCorreo" runat="server" CssClass="form-control" placeholder="Nick o Correo" ClientIDMode="Static" />
            ...
            <a href="CambiarContrasena.aspx" class="btn-back"><i class="fas fa-exchange-alt"></i> Ya tengo mi clave temporal</a>
