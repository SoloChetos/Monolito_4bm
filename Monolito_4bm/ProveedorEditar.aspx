<%@ Page Title="Editar Proveedor" Language="C#" MasterPageFile="~/PrincipalMaster.master" AutoEventWireup="true" CodeBehind="ProveedorEditar.aspx.cs" Inherits="Monolito_4bm.ProveedorEditar" %>
    ...
    <div class="page-container mt-4">
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb" style="background:none; padding:0; margin:0;">
                ...
                <li class="breadcrumb-item active text-dark" aria-current="page">Editar proveedor</li>
            </ol>
        </nav>

        <div class="card-editar">
            <h1 class="h5 fw-bold text-dark mb-4">
                <i class="fas fa-truck me-2" style="color:#555;"></i>Editar proveedor
            </h1>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <asp:Button ID="btnGuardar" runat="server" Text="Guardar cambios" CssClass="btn btn-dark" OnClick="btnGuardar_Click" />
